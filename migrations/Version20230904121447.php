 ...
 */
final class Version20230904121447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sub_menus CHANGE submenuOrder submenu_order INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sub_menus CHANGE submenu_order submenuOrder INT DEFAULT NULL');
